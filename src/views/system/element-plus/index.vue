...
const formRules: FormRules = reactive({
  ...
  pic: [{ required: true, trigger: "change", message: "请上传图片" }]
})
const handleCreate = () => {
  ...
  <div class="app-container">
    ...
    <el-card v-loading="loading" shadow="never">
      ...
      <div class="table-wrapper">
        <el-table :data="tableData">
          ...
          <el-table-column prop="username" label="图片KEY" align="center" />
          ...
          <el-table-column prop="phone" label="图片名称" align="center" />
          <el-table-column prop="email" label="图片地址" align="center" />
    ...
    >
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="left">
        ...
        <el-form-item prop="password" label="图片名称">
